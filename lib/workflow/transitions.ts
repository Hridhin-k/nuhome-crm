...
export const WORKFLOW_TRANSITIONS: Record<WorkflowStatus, WorkflowStatus[]> = {
  ...
  quote_sent_to_customer: ["payment_pending_verification", "order_active", "quote_draft", "cancelled"],
  ...
  items_received: ["delivery_pending_payment", "delivery_unlocked", "cancelled"],
  delivery_pending_payment: ["delivery_unlocked", "order_on_hold", "cancelled"],
  order_on_hold: ["payment_pending_verification", "delivery_unlocked", "cancelled"],
